...
checkpoint1 = torch.load('./sae_weights/ae1_best.pth')
...
class AE12(nn.Module):
    def __init__(self) -> None:
        super().__init__()
        self.ae1 = ae1
        for params in self.ae1.parameters():
...
for epoch in range(EPOCHS):
    ...
    valid_epoch_loss = validate_epoch(model, valid_loader, criterion)
    ...
    save_best_model(valid_epoch_loss, epoch, model, optimizer, criterion, data_path='./sae_weights/ae12_best.pth')
    print('=' * 75)

#SAVE THE TRAINED MODEL WEIGHTS FOR FINAL TIME
save_model(EPOCHS, model, optimizer, criterion, path_to_save='./sae_weights/ae12_final.pth')
